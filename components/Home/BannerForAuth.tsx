...
const BannerForAuth = () => {
  ...
  return (
    ...
    <div className="bg-gradient-to-r from-primary-1 to-slate-800 text-white py-12 md:py-20 px-6 md:px-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-2">
      ...
      <div className="space-y-6 flex flex-col justify-center items-center">
        ...
        <Button onClick={() => route.push("/jobs")} className="w-48 bg-secondary-1 hover:bg-secondary-1">
          Apply for Jobs
        </Button>
      </div>
      ...
      <div className="space-y-6 flex flex-col justify-center items-center">
        ...
        <Button  onClick={() => dispatch(openEmployerRegisterModal())} className="w-48 bg-secondary-1 hover:bg-secondary-1">
          Post a Job
        </Button>
      </div>
      </div>
